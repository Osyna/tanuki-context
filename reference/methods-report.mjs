...
generated by <code>reference/methods-report.mjs</code> · rust binary <code>estimate</code>, no pxpipe oracle · image-tokens = 28-px patch grid (⌈w/28⌉×⌈h/28⌉ per page)<br>
